package com.prototypes.sabjiwalashopkeeper.order_ready;
...
public class OrderReadyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shipped_button = findViewById(R.id.shipped_button);
        ...
        getSupportActionBar().setTitle(getString(R.string.order_ready));
        ...
        shipped_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        for (QueryDocumentSnapshot documentSnapshot : task.getResult()) {
                            ...
                            total_price.setText(getString(R.string.rupee_symbol) + String.format("%.2f", totalPrice));
